...
`D:\AI\Dictionary\project-management-pattern-dictionary`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/project-management-pattern-dictionary-docs.zip` を取得できることを確認する。
...
5. プロジェクト運用の定石を状況、失敗例、判断基準で検索できるようにする
